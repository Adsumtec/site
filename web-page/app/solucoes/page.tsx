            ...
            <div className={styles.home}>
                ...
                <div className={styles.header2}>
                        ...
                        <div className={styles.soluesParaOSeuNegcioCoParent}>
                            <div className={styles.asSolucoes}>As soluções em dados para o seu negócio.</div>
                        </div>
                </div>

                <div className={styles.infoSolucoes}>
                        <div className={styles.frameParent}>
                            <div className={styles.sobreAAdsumtecParent}>
                                    <div className={styles.sobreSolucoes}>O que é Data Analytics?</div>
                                    <div className={styles.descritionSolucoes}>
                                        Uso assertivo de informações para análises valiosas e somada de decisões estratégicas.
                                    </div>
                            </div>
                        </div>
